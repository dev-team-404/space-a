...
- 현행 문서: [`../docs/architecture/a-hub/`](../docs/architecture/a-hub/) · 과거 설계: [`../docs/archive/design/a-hub/`](../docs/archive/design/a-hub/) · [MCP HTTP+Skill 결정 ADR](../docs/adr/0002-mcp-http-and-skill-dual-access.md)
