...
def test_register_agent_issues_id_token_and_joins_space(service):
    ...
    agent, token = service.register_agent("build-bot", "sw-innov")
...
def test_two_agents_get_distinct_ids_and_tokens(service):
    ...
    a1, t1 = service.register_agent("bot-1", "sw-innov")
    a2, t2 = service.register_agent("bot-2", "sw-innov")
...
def test_register_into_missing_space_is_rejected(service):
    with pytest.raises(errors.NotFound):
        service.register_agent("build-bot", "ghost-team")
