<script lang="ts">
  import { getDiary, lifeContentAccess, lifePeople, lifeSetContentVisibility, lifeSetDiaryVisibility, lifeSetFriend, lifeView, listDiaryDates, profileGet, profileSet, regenerateSprite, type LifePerson, type Profile } from '../api';
...
.hint2{color:var(--text-soft);font-size:11px;margin-top:8px}</style>
