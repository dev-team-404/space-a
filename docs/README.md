...
| [0003](./adr/0003-life-placement-geometry-v2.md) | 방 배치 좌표와 footprint 의미를 통일한다 | 채택 |
...
| [0010](./adr/0010-register-desk-source-basis-to-life-grid.md) | 책상 원본 투영축을 방 격자에 등록하고 전체 박스를 footprint에 맞춘다 | 채택 |
