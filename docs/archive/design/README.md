...
| [life-visit.md](a-hub/specs/life-visit.md) | 2+3 걸침 | 방 방문 — 개인 방 격자·에이전트 위치 서버·미니홈피 뷰 규칙 (허준녕) |
...
| ~~overview-mentor/~~ | 1 | a-mate 초기 스펙 묶음 — 전부 완료되어 [`../archive/design/overview-mentor/`](a-mate/specs/)로 이관 (2026-08-03) |
...
완료된 plan은 같은 PR에서 `docs-archive` 스킬로 [`../archive/`](../)에 미러합니다
