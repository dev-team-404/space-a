...
- **관계**:
  ...
  - life 서버 API 계약의 정본은 [docs/design/life-visit.md §4](../../a-hub/specs/life-visit.md) — 이번 방문 추적 엔드포인트를 같은 표에 추가한다. **contracts/ 미접촉**(C2는 work hub→a-lens 계약 — 조사로 확인, P3 스펙과 동일 결론).
