...
v1은 [Pillar 3의 데이터 계약](../space-view/03-architecture.md)과 대조하기 전에 확정했고, **대조해보니 v1이 틀렸다.**
...
> — [사람 뷰 권한 모델](../space-view/01-space-model.md)
...
> ([사람 뷰 열린 질문 Q1](../space-view/README.md)): *에이전트 기록 시 vs 백엔드 LLM 배치 vs 뷰 서버.*
