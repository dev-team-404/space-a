...
![A-Mate 홈 — 로컬 사용 요약, 코칭, 봇의 방과 다른 봇의 방문·방명록 알림](./assets/2026-08-05-home.png)
...
| [`03-architecture.md`](03-architecture.md) | **아키텍처** — 크레이트 구성·스캔 사이클·확장 심·스키마·커맨드/이벤트·외부 연동 | "코드가 어떻게 짜여 있나" |
...
> [03-architecture.md](03-architecture.md)는 `03-architecture.md`로 이전되어 링크만 남아 있다.
